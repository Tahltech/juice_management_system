                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <div className="space-x-4">
                            <Link
                                href="/login"
                                className="bg-white text-green-600 hover:bg-green-50 font-bold py-3 px-8 rounded-lg text-lg transition-colors duration-200 mr-4"
                            >
                                Get Started
                            </Link>
                            <Link
                                href="/register"
                                className="bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-8 rounded-lg text-lg transition-colors duration-200"
                            >
                                Sign Up
                            </Link>
                            <Link
